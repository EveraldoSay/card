    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['usuario']) || empty($_POST['clave'])) {
            ...
            if ($resultado > 0) {
                ...
                $_SESSION['perfil'] = $dato['perfil'];
                if ($_SESSION['perfil'] == "cliente") {
                    // $alert = '<div class="alert alert-succes text-center alert-dismissible fade show" role="alert">
                    //     Es Cliente
                    //     <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    //         <span aria-hidden="true">&times;</span>
                    //     </button>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">PharmaPlus</h1>
